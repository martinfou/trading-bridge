 ...
 * SL: 145 pips, PT: 370 pips
 * Expiration: 113 bars
 */
public class Strategy_2_31_175_Converted implements Strategy {
    ...
    @Override
    public String name() {
        return "Strategy_2_31_175_Converted";
    }
    ...
    public void onBar(Bar bar) {
        ...
        // LongEntrySignal:
                ...
                if (longEntry && !(activeOrder != null) && !(false)) {
                    ...
                    double entryPrice = close1 + (2.2 * atr);
                    {
                    double ep = entryPrice;
                    double sl = ep - (145 * PIP);
                    double tp = ep + (370 * PIP);
