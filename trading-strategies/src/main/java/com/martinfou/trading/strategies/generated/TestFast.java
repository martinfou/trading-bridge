...
/**
 * TestFast — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>SMA(50, CLOSE)</li>
 ...
 * </ul>
 */
public class TestFast implements Strategy {
    ...
    /**
     * Creates a new TestFast strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public TestFast(String symbol) {
        this.name = "TestFast";
        this.symbol = symbol;
    }
