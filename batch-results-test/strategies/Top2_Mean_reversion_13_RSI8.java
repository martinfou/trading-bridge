...
/**
 * Top2_Mean_reversion_13_RSI8 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(8, CLOSE)</li>
 ...
 * </ul>
 */
public class Top2_Mean_reversion_13_RSI8 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 21;
    private static final int TAKE_PROFIT_POINTS = 158;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top2_Mean_reversion_13_RSI8 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top2_Mean_reversion_13_RSI8(String symbol) {
        this.name = "Top2_Mean_reversion_13_RSI8";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (hasPosition) {
            ...
            if (sma_31_close < prevSma_31_close) {
                exitTriggered = true;
            }
