...
/**
 * Top15_Momentum_4_EMA19 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(19, CLOSE)</li>
 ...
 * </ul>
 */
public class Top15_Momentum_4_EMA19 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 118;
    private static final int TAKE_PROFIT_POINTS = 264;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top15_Momentum_4_EMA19 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top15_Momentum_4_EMA19(String symbol) {
        this.name = "Top15_Momentum_4_EMA19";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_19_close <= prevEma_29_close && ema_19_close > ema_29_close) {
                entryTriggered = true;
            }
