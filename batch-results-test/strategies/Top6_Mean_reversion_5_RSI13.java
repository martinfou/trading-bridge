...
/**
 * Top6_Mean_reversion_5_RSI13 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(13, CLOSE)</li>
 ...
 * </ul>
 */
public class Top6_Mean_reversion_5_RSI13 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 57;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top6_Mean_reversion_5_RSI13 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top6_Mean_reversion_5_RSI13(String symbol) {
        this.name = "Top6_Mean_reversion_5_RSI13";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_13_close <= prevEma_24_close && rsi_13_close > ema_24_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (sma_84_close < prevSma_84_close) {
                exitTriggered = true;
            }
