...
/**
 * Top16_Mean_reversion_4_RSI19 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(19, CLOSE)</li>
 ...
 * </ul>
 */
public class Top16_Mean_reversion_4_RSI19 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 84;
    private static final int TAKE_PROFIT_POINTS = 203;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top16_Mean_reversion_4_RSI19 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top16_Mean_reversion_4_RSI19(String symbol) {
        this.name = "Top16_Mean_reversion_4_RSI19";
        this.symbol = symbol;
    }
