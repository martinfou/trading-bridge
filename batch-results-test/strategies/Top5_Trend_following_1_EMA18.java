...
/**
 * Top5_Trend_following_1_EMA18 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(18, CLOSE)</li>
 ...
 * </ul>
 */
public class Top5_Trend_following_1_EMA18 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 34;
    private static final int TAKE_PROFIT_POINTS = 46;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top5_Trend_following_1_EMA18 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top5_Trend_following_1_EMA18(String symbol) {
        this.name = "Top5_Trend_following_1_EMA18";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_18_close <= prevEma_31_close && ema_18_close > ema_31_close) {
                entryTriggered = true;
            }
