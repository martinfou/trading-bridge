...
/**
 * Top1_Mean_reversion_12_RSI20 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(20, CLOSE)</li>
 ...
 * </ul>
 */
public class Top1_Mean_reversion_12_RSI20 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 165;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top1_Mean_reversion_12_RSI20 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top1_Mean_reversion_12_RSI20(String symbol) {
        this.name = "Top1_Mean_reversion_12_RSI20";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_20_close <= prevSma_16_close && rsi_20_close > sma_16_close) {
                entryTriggered = true;
            }
