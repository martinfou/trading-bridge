...
/**
 * Top9_Trend_following_10_EMA6 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(6, CLOSE)</li>
 ...
 * </ul>
 */
public class Top9_Trend_following_10_EMA6 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 174;
    private static final int TAKE_PROFIT_POINTS = 193;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top9_Trend_following_10_EMA6 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top9_Trend_following_10_EMA6(String symbol) {
        this.name = "Top9_Trend_following_10_EMA6";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (hasPosition) {
            ...
            if (sma_85_close < prevSma_85_close) {
                exitTriggered = true;
            }
