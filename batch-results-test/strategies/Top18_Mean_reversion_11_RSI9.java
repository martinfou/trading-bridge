...
/**
 * Top18_Mean_reversion_11_RSI9 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(9, CLOSE)</li>
 ...
 * </ul>
 */
public class Top18_Mean_reversion_11_RSI9 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 9;
    private static final int TAKE_PROFIT_POINTS = 40;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top18_Mean_reversion_11_RSI9 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top18_Mean_reversion_11_RSI9(String symbol) {
        this.name = "Top18_Mean_reversion_11_RSI9";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (history.size() < 9) return;

        // --- Compute indicator values ---
        double rsi_9_close = rsi(history, 9);
