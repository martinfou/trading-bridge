...
/**
 * Top17_Mean_reversion_10_RSI11 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(11, CLOSE)</li>
 ...
 * </ul>
 */
public class Top17_Mean_reversion_10_RSI11 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 213;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top17_Mean_reversion_10_RSI11 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top17_Mean_reversion_10_RSI11(String symbol) {
        this.name = "Top17_Mean_reversion_10_RSI11";
        this.symbol = symbol;
    }
