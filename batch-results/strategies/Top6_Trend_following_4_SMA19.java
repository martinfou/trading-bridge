...
/**
 * Top6_Trend_following_4_SMA19 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>SMA(19, CLOSE)</li>
 ...
 * </ul>
 */
public class Top6_Trend_following_4_SMA19 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 99;
    private static final int TAKE_PROFIT_POINTS = 273;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top6_Trend_following_4_SMA19 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top6_Trend_following_4_SMA19(String symbol) {
        this.name = "Top6_Trend_following_4_SMA19";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        double adx_18_close = adx(history, 18);
        double sma_9_close = sma(history, 9, "CLOSE");

        // --- Previous indicator values ---
        double prevSma_19_close = smaPrev(history, 19, "CLOSE");
        double prevAdx_18_close = adxPrev(history, 18);
        double prevSma_9_close = smaPrev(history, 9, "CLOSE");

        // --- Entry conditions ---
        if (!hasPosition) {
            boolean entryTriggered = false;
            if (prevSma_19_close <= prevAdx_18_close && sma_19_close > adx_18_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (sma_9_close < prevSma_9_close) {
                exitTriggered = true;
            }
