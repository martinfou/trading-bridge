...
/**
 * Top19_Mean_reversion_2_RSI14 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(14, CLOSE)</li>
 ...
 * </ul>
 */
public class Top19_Mean_reversion_2_RSI14 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 36;
    private static final int TAKE_PROFIT_POINTS = 149;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top19_Mean_reversion_2_RSI14 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top19_Mean_reversion_2_RSI14(String symbol) {
        this.name = "Top19_Mean_reversion_2_RSI14";
        this.symbol = symbol;
    }
