...
/**
 * Top1_Mean_reversion_1_RSI13 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(13, CLOSE)</li>
 ...
 * </ul>
 */
public class Top1_Mean_reversion_1_RSI13 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 79;
    private static final int TAKE_PROFIT_POINTS = 178;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top1_Mean_reversion_1_RSI13 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top1_Mean_reversion_1_RSI13(String symbol) {
        this.name = "Top1_Mean_reversion_1_RSI13";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        double ema_21_close = ema(history, 21, "CLOSE");
        double sma_40_close = sma(history, 40, "CLOSE");

        // --- Previous indicator values ---
        double prevRsi_13_close = rsiPrev(history, 13);
        double prevEma_21_close = emaPrev(history, 21, "CLOSE");
        double prevSma_40_close = smaPrev(history, 40, "CLOSE");

        // --- Entry conditions ---
        if (!hasPosition) {
            boolean entryTriggered = false;
            if (prevRsi_13_close <= prevEma_21_close && rsi_13_close > ema_21_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (sma_40_close < prevSma_40_close) {
                exitTriggered = true;
            }
