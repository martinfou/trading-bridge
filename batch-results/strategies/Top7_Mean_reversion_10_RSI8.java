...
/**
 * Top7_Mean_reversion_10_RSI8 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(8, CLOSE)</li>
 ...
 * </ul>
 */
public class Top7_Mean_reversion_10_RSI8 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 24;
    private static final int TAKE_PROFIT_POINTS = 33;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top7_Mean_reversion_10_RSI8 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top7_Mean_reversion_10_RSI8(String symbol) {
        this.name = "Top7_Mean_reversion_10_RSI8";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_8_close <= prevSma_42_close && rsi_8_close > sma_42_close) {
                entryTriggered = true;
            }
