...
/**
 * Top3_Trend_following_5_EMA20 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(20, CLOSE)</li>
 ...
 * </ul>
 */
public class Top3_Trend_following_5_EMA20 implements Strategy {
    ...
    /**
     * Creates a new Top3_Trend_following_5_EMA20 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top3_Trend_following_5_EMA20(String symbol) {
        this.name = "Top3_Trend_following_5_EMA20";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (hasPosition) {
            ...
            if (sma_78_close < prevSma_78_close) {
                exitTriggered = true;
            }
