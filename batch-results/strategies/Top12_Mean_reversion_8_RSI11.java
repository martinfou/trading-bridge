...
/**
 * Top12_Mean_reversion_8_RSI11 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(11, CLOSE)</li>
 ...
 * </ul>
 */
public class Top12_Mean_reversion_8_RSI11 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 76;
    private static final int TAKE_PROFIT_POINTS = 187;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top12_Mean_reversion_8_RSI11 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top12_Mean_reversion_8_RSI11(String symbol) {
        this.name = "Top12_Mean_reversion_8_RSI11";
        this.symbol = symbol;
    }
