...
/**
 * Top7_Mean_reversion_3_RSI8 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(8, CLOSE)</li>
 ...
 * </ul>
 */
public class Top7_Mean_reversion_3_RSI8 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 111;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top7_Mean_reversion_3_RSI8 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top7_Mean_reversion_3_RSI8(String symbol) {
        this.name = "Top7_Mean_reversion_3_RSI8";
        this.symbol = symbol;
    }
