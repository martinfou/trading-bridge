...
/**
 * Top10_Trend_following_9_EMA8 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(8, CLOSE)</li>
 ...
 * </ul>
 */
public class Top10_Trend_following_9_EMA8 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 218;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top10_Trend_following_9_EMA8 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top10_Trend_following_9_EMA8(String symbol) {
        this.name = "Top10_Trend_following_9_EMA8";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_8_close <= prevEma_40_close && ema_8_close > ema_40_close) {
                entryTriggered = true;
            }
