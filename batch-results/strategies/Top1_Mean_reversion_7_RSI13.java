...
/**
 * Top1_Mean_reversion_7_RSI13 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(13, CLOSE)</li>
 ...
 * </ul>
 */
public class Top1_Mean_reversion_7_RSI13 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 49;
    private static final int TAKE_PROFIT_POINTS = 177;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top1_Mean_reversion_7_RSI13 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top1_Mean_reversion_7_RSI13(String symbol) {
        this.name = "Top1_Mean_reversion_7_RSI13";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_13_close <= prevEma_17_close && rsi_13_close > ema_17_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (sma_53_close < prevSma_53_close) {
                exitTriggered = true;
            }
