...
/**
 * Top8_Trend_following_4_SMA81 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>SMA(81, CLOSE)</li>
 ...
 * </ul>
 */
public class Top8_Trend_following_4_SMA81 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 151;
    private static final int TAKE_PROFIT_POINTS = 205;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top8_Trend_following_4_SMA81 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top8_Trend_following_4_SMA81(String symbol) {
        this.name = "Top8_Trend_following_4_SMA81";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (history.size() < 81) return;

        // --- Compute indicator values ---
        double sma_81_close = sma(history, 81, "CLOSE");
        double adx_15_close = adx(history, 15);
        double sma_40_close = sma(history, 40, "CLOSE");

        // --- Previous indicator values ---
        double prevSma_81_close = smaPrev(history, 81, "CLOSE");
        ...
        if (!hasPosition) {
            ...
            if (prevSma_81_close <= prevAdx_15_close && sma_81_close > adx_15_close) {
                entryTriggered = true;
            }
