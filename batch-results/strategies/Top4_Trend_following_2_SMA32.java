...
/**
 * Top4_Trend_following_2_SMA32 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>SMA(32, CLOSE)</li>
 ...
 * </ul>
 */
public class Top4_Trend_following_2_SMA32 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 53;
    private static final int TAKE_PROFIT_POINTS = 236;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top4_Trend_following_2_SMA32 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top4_Trend_following_2_SMA32(String symbol) {
        this.name = "Top4_Trend_following_2_SMA32";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevSma_32_close <= prevAdx_19_close && sma_32_close > adx_19_close) {
                entryTriggered = true;
            }
