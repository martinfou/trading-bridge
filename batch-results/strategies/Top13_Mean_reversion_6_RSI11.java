...
/**
 * Top13_Mean_reversion_6_RSI11 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(11, CLOSE)</li>
 ...
 * </ul>
 */
public class Top13_Mean_reversion_6_RSI11 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 88;
    private static final int TAKE_PROFIT_POINTS = 150;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top13_Mean_reversion_6_RSI11 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top13_Mean_reversion_6_RSI11(String symbol) {
        this.name = "Top13_Mean_reversion_6_RSI11";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_11_close <= prevEma_20_close && rsi_11_close > ema_20_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (sma_25_close < prevSma_25_close) {
                exitTriggered = true;
            }
