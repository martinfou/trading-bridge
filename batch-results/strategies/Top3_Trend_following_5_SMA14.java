...
/**
 * Top3_Trend_following_5_SMA14 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>SMA(14, CLOSE)</li>
 ...
 * </ul>
 */
public class Top3_Trend_following_5_SMA14 implements Strategy {
    ...
    /**
     * Creates a new Top3_Trend_following_5_SMA14 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top3_Trend_following_5_SMA14(String symbol) {
        this.name = "Top3_Trend_following_5_SMA14";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        double sma_14_close = sma(history, 14, "CLOSE");
        double adx_10_close = adx(history, 10);
        double sma_7_close = sma(history, 7, "CLOSE");

        // --- Previous indicator values ---
        double prevSma_14_close = smaPrev(history, 14, "CLOSE");
        double prevAdx_10_close = adxPrev(history, 10);
        double prevSma_7_close = smaPrev(history, 7, "CLOSE");

        // --- Entry conditions ---
        if (!hasPosition) {
            boolean entryTriggered = false;
            if (prevSma_14_close <= prevAdx_10_close && sma_14_close > adx_10_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (sma_7_close < prevSma_7_close) {
                exitTriggered = true;
            }
