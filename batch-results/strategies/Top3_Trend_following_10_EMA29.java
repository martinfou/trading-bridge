...
/**
 * Top3_Trend_following_10_EMA29 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(29, CLOSE)</li>
 ...
 * </ul>
 */
public class Top3_Trend_following_10_EMA29 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 147;
    private static final int TAKE_PROFIT_POINTS = 361;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top3_Trend_following_10_EMA29 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top3_Trend_following_10_EMA29(String symbol) {
        this.name = "Top3_Trend_following_10_EMA29";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (hasPosition) {
            ...
            if (ema_56_close < prevEma_56_close) {
                exitTriggered = true;
            }
