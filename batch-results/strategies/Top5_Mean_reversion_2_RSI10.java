...
/**
 * Top5_Mean_reversion_2_RSI10 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(10, CLOSE)</li>
 ...
 * </ul>
 */
public class Top5_Mean_reversion_2_RSI10 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 124;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top5_Mean_reversion_2_RSI10 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top5_Mean_reversion_2_RSI10(String symbol) {
        this.name = "Top5_Mean_reversion_2_RSI10";
        this.symbol = symbol;
    }
