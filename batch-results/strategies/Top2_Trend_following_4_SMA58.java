...
/**
 * Top2_Trend_following_4_SMA58 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>SMA(58, CLOSE)</li>
 ...
 * </ul>
 */
public class Top2_Trend_following_4_SMA58 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 16;
    private static final int TAKE_PROFIT_POINTS = 207;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top2_Trend_following_4_SMA58 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top2_Trend_following_4_SMA58(String symbol) {
        this.name = "Top2_Trend_following_4_SMA58";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (hasPosition) {
            ...
            if (sma_29_close < prevSma_29_close) {
                exitTriggered = true;
            }
