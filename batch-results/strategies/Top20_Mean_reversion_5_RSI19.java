...
/**
 * Top20_Mean_reversion_5_RSI19 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(19, CLOSE)</li>
 ...
 * </ul>
 */
public class Top20_Mean_reversion_5_RSI19 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 47;
    private static final int TAKE_PROFIT_POINTS = 176;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top20_Mean_reversion_5_RSI19 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top20_Mean_reversion_5_RSI19(String symbol) {
        this.name = "Top20_Mean_reversion_5_RSI19";
        this.symbol = symbol;
    }
