...
import com.ib.client.SmartComponents;
...
/**
 * A default adapter for EWrapper to avoid having to implement all 100+ methods.
 */
public abstract class DefaultEWrapper implements EWrapper {
    ...
    @Override public void tickSize(int tickerId, int field, java.text.DecimalFormat size) {}
    ...
    @Override public void tickEFP(int tickerId, int tickType, double basisPoints, String formattedBasisPoints, double impliedFuture, int holdDays, String futureLastTradeDate, double dividendImpact, double dividendsToExpiry) {}
    @Override public void orderStatus(int orderId, String status, java.text.DecimalFormat filled, java.text.DecimalFormat remaining, double avgFillPrice, int permId, int parentId, double lastFillPrice, int clientId, String whyHeld, double mktCapPrice) {}
    ...
    @Override public void updatePortfolio(Contract contract, java.text.DecimalFormat position, double marketPrice, double marketValue, double averageCost, double unrealizedPNL, double realizedPNL, String accountName) {}
    ...
    @Override public void updateMktDepth(int tickerId, int position, int operation, int side, double price, java.text.DecimalFormat size) {}
    @Override public void updateMktDepthL2(int tickerId, int position, String marketMaker, int operation, int side, double price, java.text.DecimalFormat size, boolean isSmartDepth) {}
    ...
    @Override public void realtimeBar(int reqId, long time, double open, double high, double low, double close, java.text.DecimalFormat volume, java.text.DecimalFormat wap, int count) {}
    ...
    @Override public void position(String account, Contract contract, java.text.DecimalFormat pos, double avgCost) {}
    ...
    @Override public void positionMulti(int reqId, String account, String modelCode, Contract contract, java.text.DecimalFormat pos, double avgCost) {}
    ...
    @Override public void familyCodes(SoftDollarTier[] familyCodes) {} // Note: Signature in TWS API is SoftDollarTier[] but often unused
    @Override public void symbolSamples(int reqId, ContractDetails[] contractDescriptions) {}
    ...
    @Override public void smartComponents(int reqId, Map<Integer, Entry<String, Character>> theMap) {}
    ...
    @Override public void pnlSingle(int reqId, java.text.DecimalFormat pos, double dailyPnL, double unrealizedPnL, double realizedPnL, double value) {}
    ...
    @Override public void tickByTickAllLast(int reqId, int tickType, long time, double price, java.text.DecimalFormat size, TickAttribLast tickAttribLast, String exchange, String specialConditions) {}
    @Override public void tickByTickBidAsk(int reqId, long time, double bidPrice, double askPrice, java.text.DecimalFormat bidSize, java.text.DecimalFormat askSize, TickAttribBidAsk tickAttribBidAsk) {}
