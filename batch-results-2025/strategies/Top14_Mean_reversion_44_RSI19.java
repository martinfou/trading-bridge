...
/**
 * Top14_Mean_reversion_44_RSI19 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(19, CLOSE)</li>
 ...
 * </ul>
 */
public class Top14_Mean_reversion_44_RSI19 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 167;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top14_Mean_reversion_44_RSI19 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top14_Mean_reversion_44_RSI19(String symbol) {
        this.name = "Top14_Mean_reversion_44_RSI19";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        double sma_12_close = sma(history, 12, "CLOSE");

        // --- Previous indicator values ---
        double prevRsi_19_close = rsiPrev(history, 19);
        double prevSma_12_close = smaPrev(history, 12, "CLOSE");

        // --- Entry conditions ---
        if (!hasPosition) {
            boolean entryTriggered = false;
            if (prevRsi_19_close <= prevSma_12_close && rsi_19_close > sma_12_close) {
                entryTriggered = true;
            }
