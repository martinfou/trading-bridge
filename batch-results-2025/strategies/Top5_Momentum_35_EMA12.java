...
/**
 * Top5_Momentum_35_EMA12 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(12, CLOSE)</li>
 ...
 * </ul>
 */
public class Top5_Momentum_35_EMA12 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 299;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top5_Momentum_35_EMA12 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top5_Momentum_35_EMA12(String symbol) {
        this.name = "Top5_Momentum_35_EMA12";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_12_close <= prevEma_31_close && ema_12_close > ema_31_close) {
                entryTriggered = true;
            }
