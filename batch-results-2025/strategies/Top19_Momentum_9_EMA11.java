...
/**
 * Top19_Momentum_9_EMA11 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(11, CLOSE)</li>
 ...
 * </ul>
 */
public class Top19_Momentum_9_EMA11 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 306;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top19_Momentum_9_EMA11 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top19_Momentum_9_EMA11(String symbol) {
        this.name = "Top19_Momentum_9_EMA11";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_11_close <= prevEma_36_close && ema_11_close > ema_36_close) {
                entryTriggered = true;
            }
