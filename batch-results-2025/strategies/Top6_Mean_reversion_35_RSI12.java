...
/**
 * Top6_Mean_reversion_35_RSI12 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(12, CLOSE)</li>
 ...
 * </ul>
 */
public class Top6_Mean_reversion_35_RSI12 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 22;
    private static final int TAKE_PROFIT_POINTS = 115;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top6_Mean_reversion_35_RSI12 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top6_Mean_reversion_35_RSI12(String symbol) {
        this.name = "Top6_Mean_reversion_35_RSI12";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_12_close <= prevSma_67_close && rsi_12_close > sma_67_close) {
                entryTriggered = true;
            }
