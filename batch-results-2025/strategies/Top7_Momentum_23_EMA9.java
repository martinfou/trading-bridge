...
/**
 * Top7_Momentum_23_EMA9 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(9, CLOSE)</li>
 ...
 * </ul>
 */
public class Top7_Momentum_23_EMA9 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 10;
    private static final int TAKE_PROFIT_POINTS = 232;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top7_Momentum_23_EMA9 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top7_Momentum_23_EMA9(String symbol) {
        this.name = "Top7_Momentum_23_EMA9";
        this.symbol = symbol;
    }
