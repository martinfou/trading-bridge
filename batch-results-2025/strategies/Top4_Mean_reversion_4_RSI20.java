...
/**
 * Top4_Mean_reversion_4_RSI20 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(20, CLOSE)</li>
 ...
 * </ul>
 */
public class Top4_Mean_reversion_4_RSI20 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 14;
    private static final int TAKE_PROFIT_POINTS = 29;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top4_Mean_reversion_4_RSI20 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top4_Mean_reversion_4_RSI20(String symbol) {
        this.name = "Top4_Mean_reversion_4_RSI20";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_20_close <= prevSma_14_close && rsi_20_close > sma_14_close) {
                entryTriggered = true;
            }
