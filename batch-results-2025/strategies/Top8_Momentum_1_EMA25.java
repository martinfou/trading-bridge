...
/**
 * Top8_Momentum_1_EMA25 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(25, CLOSE)</li>
 ...
 * </ul>
 */
public class Top8_Momentum_1_EMA25 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 107;
    private static final int TAKE_PROFIT_POINTS = 197;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top8_Momentum_1_EMA25 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top8_Momentum_1_EMA25(String symbol) {
        this.name = "Top8_Momentum_1_EMA25";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_25_close <= prevEma_47_close && ema_25_close > ema_47_close) {
                entryTriggered = true;
            }
