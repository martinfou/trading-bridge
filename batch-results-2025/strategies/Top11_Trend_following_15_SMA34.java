...
/**
 * Top11_Trend_following_15_SMA34 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>SMA(34, CLOSE)</li>
 ...
 * </ul>
 */
public class Top11_Trend_following_15_SMA34 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 87;
    private static final int TAKE_PROFIT_POINTS = 374;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top11_Trend_following_15_SMA34 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top11_Trend_following_15_SMA34(String symbol) {
        this.name = "Top11_Trend_following_15_SMA34";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevSma_34_close <= prevSma_64_close && sma_34_close > sma_64_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (prevSma_44_close >= prevSma_64_close && sma_44_close < sma_64_close) {
                exitTriggered = true;
            }
