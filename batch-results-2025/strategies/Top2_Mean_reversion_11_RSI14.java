...
/**
 * Top2_Mean_reversion_11_RSI14 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(14, CLOSE)</li>
 ...
 * </ul>
 */
public class Top2_Mean_reversion_11_RSI14 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 32;
    private static final int TAKE_PROFIT_POINTS = 64;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top2_Mean_reversion_11_RSI14 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top2_Mean_reversion_11_RSI14(String symbol) {
        this.name = "Top2_Mean_reversion_11_RSI14";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_14_close <= prevSma_24_close && rsi_14_close > sma_24_close) {
                entryTriggered = true;
            }
