...
/**
 * Top18_Momentum_15_EMA14 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(14, CLOSE)</li>
 ...
 * </ul>
 */
public class Top18_Momentum_15_EMA14 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 139;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top18_Momentum_15_EMA14 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top18_Momentum_15_EMA14(String symbol) {
        this.name = "Top18_Momentum_15_EMA14";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_14_close <= prevEma_32_close && ema_14_close > ema_32_close) {
                entryTriggered = true;
            }
