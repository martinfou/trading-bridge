...
/**
 * Top17_Momentum_44_EMA25 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(25, CLOSE)</li>
 ...
 * </ul>
 */
public class Top17_Momentum_44_EMA25 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 70;
    private static final int TAKE_PROFIT_POINTS = 344;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top17_Momentum_44_EMA25 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top17_Momentum_44_EMA25(String symbol) {
        this.name = "Top17_Momentum_44_EMA25";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_25_close <= prevEma_33_close && ema_25_close > ema_33_close) {
                entryTriggered = true;
            }
