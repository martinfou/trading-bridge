...
/**
 * Top16_Mean_reversion_22_RSI16 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(16, CLOSE)</li>
 ...
 * </ul>
 */
public class Top16_Mean_reversion_22_RSI16 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 26;
    private static final int TAKE_PROFIT_POINTS = 127;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top16_Mean_reversion_22_RSI16 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top16_Mean_reversion_22_RSI16(String symbol) {
        this.name = "Top16_Mean_reversion_22_RSI16";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_16_close <= prevSma_44_close && rsi_16_close > sma_44_close) {
                entryTriggered = true;
            }
