...
/**
 * Top3_Momentum_43_RSI7 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(7, CLOSE)</li>
 ...
 * </ul>
 */
public class Top3_Momentum_43_RSI7 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 93;
    private static final int TAKE_PROFIT_POINTS = 311;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top3_Momentum_43_RSI7 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top3_Momentum_43_RSI7(String symbol) {
        this.name = "Top3_Momentum_43_RSI7";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_7_close <= prevAdx_17_close && rsi_7_close > adx_17_close) {
                entryTriggered = true;
            }
