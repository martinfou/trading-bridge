...
public class RunLtDoubleMA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("  EMA(50) / SMA(200) crossover · SL=2×ATR · TP=4×ATR");
        System.out.println("=" .repeat(90));

        System.out.println("\n" + "─".repeat(90));
        System.out.println("  EUR_USD — Full Range (2006-2026)");
        System.out.println("─".repeat(90));
        ...
        System.out.println("\n" + "─".repeat(90));
        System.out.println("  GBP_USD — Full Range (2006-2026)");
        System.out.println("─".repeat(90));
    ...
    private static void runSymbol(String symbol, String yearSpec) throws Exception {
        ...
        String name = "LtDoubleMA_" + symbol.replace("_", "") + "_" + yearSpec.replace("-", "");
        var strategy = new LtDoubleMA(name, symbol);
