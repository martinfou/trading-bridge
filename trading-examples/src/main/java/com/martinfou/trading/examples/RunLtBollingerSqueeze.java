...
import com.martinfou.trading.strategies.longterm.LtBollingerSqueeze;
import java.util.List;

/**
 * Validation runner for LtBollingerSqueeze — multi-asset, walk-forward.
 */
public class RunLtBollingerSqueeze {
    public static void main(String[] args) throws Exception {
        ...
        for (String[] run : runs) {
            ...
            try {
                ...
                Strategy strat = new LtBollingerSqueeze("LtBollingerSqueeze", symbol);
