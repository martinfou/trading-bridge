...
import com.martinfou.trading.strategies.longterm.LtRSIMeanRev;
import java.util.List;

/**
 * Validation runner for LtRSIMeanRev — multi-asset, walk-forward.
 *
 * Backtest matrix:
 *   - EUR_USD: full (2010-2025), IS (2010-2018), OOS1 (2019-2022), OOS2 (2023-2025)
 *   - GBP_USD: full (2010-2025), IS (2010-2018), OOS1 (2019-2022), OOS2 (2023-2025)
 */
public class RunLtRSIMeanRev {
    public static void main(String[] args) throws Exception {
        ...
        for (String[] run : runs) {
            ...
            try {
                ...
                Strategy strat = new LtRSIMeanRev("LtRSIMeanRev", symbol);
