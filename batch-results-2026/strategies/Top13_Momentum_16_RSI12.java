...
/**
 * Top13_Momentum_16_RSI12 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(12, CLOSE)</li>
 ...
 * </ul>
 */
public class Top13_Momentum_16_RSI12 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 194;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top13_Momentum_16_RSI12 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top13_Momentum_16_RSI12(String symbol) {
        this.name = "Top13_Momentum_16_RSI12";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_12_close <= prevAdx_10_close && rsi_12_close > adx_10_close) {
                entryTriggered = true;
            }
