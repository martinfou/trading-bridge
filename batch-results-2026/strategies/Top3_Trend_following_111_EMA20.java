...
/**
 * Top3_Trend_following_111_EMA20 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>EMA(20, CLOSE)</li>
 ...
 * </ul>
 */
public class Top3_Trend_following_111_EMA20 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 90;
    private static final int TAKE_PROFIT_POINTS = 388;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top3_Trend_following_111_EMA20 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top3_Trend_following_111_EMA20(String symbol) {
        this.name = "Top3_Trend_following_111_EMA20";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevEma_20_close <= prevEma_41_close && ema_20_close > ema_41_close) {
                entryTriggered = true;
            }
