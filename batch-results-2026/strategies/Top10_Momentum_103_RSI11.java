...
/**
 * Top10_Momentum_103_RSI11 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(11, CLOSE)</li>
 ...
 * </ul>
 */
public class Top10_Momentum_103_RSI11 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 393;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top10_Momentum_103_RSI11 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top10_Momentum_103_RSI11(String symbol) {
        this.name = "Top10_Momentum_103_RSI11";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_11_close <= prevAdx_17_close && rsi_11_close > adx_17_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (ema_6_close < prevEma_6_close) {
                exitTriggered = true;
            }
