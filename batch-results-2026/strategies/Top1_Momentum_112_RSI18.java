...
/**
 * Top1_Momentum_112_RSI18 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(18, CLOSE)</li>
 ...
 * </ul>
 */
public class Top1_Momentum_112_RSI18 implements Strategy {
    ...
    private static final int TAKE_PROFIT_POINTS = 224;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top1_Momentum_112_RSI18 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top1_Momentum_112_RSI18(String symbol) {
        this.name = "Top1_Momentum_112_RSI18";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_18_close <= prevAdx_11_close && rsi_18_close > adx_11_close) {
                entryTriggered = true;
            }
