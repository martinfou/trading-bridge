...
/**
 * Top12_Momentum_47_RSI18 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(18, CLOSE)</li>
 ...
 * </ul>
 */
public class Top12_Momentum_47_RSI18 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 96;
    private static final int TAKE_PROFIT_POINTS = 278;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top12_Momentum_47_RSI18 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top12_Momentum_47_RSI18(String symbol) {
        this.name = "Top12_Momentum_47_RSI18";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_18_close <= prevAdx_15_close && rsi_18_close > adx_15_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (ema_9_close < prevEma_9_close) {
                exitTriggered = true;
            }
