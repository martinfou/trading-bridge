...
/**
 * Top20_Momentum_102_RSI7 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(7, CLOSE)</li>
 ...
 * </ul>
 */
public class Top20_Momentum_102_RSI7 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 157;
    private static final int TAKE_PROFIT_POINTS = 244;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top20_Momentum_102_RSI7 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top20_Momentum_102_RSI7(String symbol) {
        this.name = "Top20_Momentum_102_RSI7";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_7_close <= prevAdx_18_close && rsi_7_close > adx_18_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (ema_14_close < prevEma_14_close) {
                exitTriggered = true;
            }
