...
/**
 * Top15_Momentum_81_RSI20 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(20, CLOSE)</li>
 ...
 * </ul>
 */
public class Top15_Momentum_81_RSI20 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 144;
    private static final int TAKE_PROFIT_POINTS = 382;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top15_Momentum_81_RSI20 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top15_Momentum_81_RSI20(String symbol) {
        this.name = "Top15_Momentum_81_RSI20";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_20_close <= prevAdx_17_close && rsi_20_close > adx_17_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (ema_16_close < prevEma_16_close) {
                exitTriggered = true;
            }
