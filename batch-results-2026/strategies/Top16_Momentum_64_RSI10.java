...
/**
 * Top16_Momentum_64_RSI10 — auto-generated from a genetic-algorithm chromosome.
 *
 * <p>Entry conditions:
 * <ul>
 *   <li>RSI(10, CLOSE)</li>
 ...
 * </ul>
 */
public class Top16_Momentum_64_RSI10 implements Strategy {
    ...
    private static final int STOP_LOSS_POINTS = 57;
    private static final int TAKE_PROFIT_POINTS = 236;
    private static final double PRICE_SCALE = 0.0001;

    /**
     * Creates a new Top16_Momentum_64_RSI10 strategy for the given symbol.
     *
     * @param symbol the trading symbol (e.g. "EUR_USD")
     */
    public Top16_Momentum_64_RSI10(String symbol) {
        this.name = "Top16_Momentum_64_RSI10";
        this.symbol = symbol;
    }
    ...
    public void onBar(Bar bar) {
        ...
        if (!hasPosition) {
            ...
            if (prevRsi_10_close <= prevAdx_14_close && rsi_10_close > adx_14_close) {
                entryTriggered = true;
            }
        ...
        if (hasPosition) {
            ...
            if (ema_29_close < prevEma_29_close) {
                exitTriggered = true;
            }
